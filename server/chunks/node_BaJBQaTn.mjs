...
import { A as renderTemplate, B as createAstro, N as addAttribute, R as unescapeHTML, _t as joinPaths, bt as removeQueryString, c as createConsoleLogger, gt as isRemotePath, ht as isParentDirectory, j as maybeRenderHead, x as spreadAttributes } from "./sequence_CulRNmGV.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_B2l3OiVh.mjs").catch((e) => {
