import { i as connection } from "./connection_BxSDNEzk.mjs";
...
var SiteKeyRejectedError = class extends Error {
	...
	constructor(status, url) {
		super(`[tds-shop] Der gekoppelte API-Zugang wurde abgelehnt (HTTP ${status}) von ${url}. Bitte den Shop in den TDShop-Einstellungen neu verbinden.`);
