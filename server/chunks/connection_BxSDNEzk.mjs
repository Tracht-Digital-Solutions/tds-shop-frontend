...
function buildApiBase() {
	return (Object.assign({
		...
		"SSR": true
	}, { _: "/opt/hostedtoolcache/node/22.23.2/x64/bin/npm" }).PUBLIC_API_URL ?? DEFAULT_API_BASE).trim().replace(/\/+$/, "");
}
function buildLoginUrl() {
	return (Object.assign({
		...
		"SITE": "https://shop.tracht-digital.de",
		"SSR": true
	}, { _: "/opt/hostedtoolcache/node/22.23.2/x64/bin/npm" }).PUBLIC_LOGIN_URL ?? DEFAULT_LOGIN_URL).trim().replace(/\/+$/, "") || DEFAULT_LOGIN_URL;
}
...
var contentApiBase = () => `${apiBase()}/content`;
...
//#endregion
export { contentApiBase as a, connection as i, connectResponse as n, publicRuntimeResponse as o, connectStatusResponse as r, apiBase as t };
